...
void student_tests() {
  ...
  Essay test1;
  test1.debug();
  std::cout << "backing up empty test\n";
  test1.backup();
  std::cout << "backed up:\n";
  test1.debug();
  std::cout << "reverting:\n";
  test1.revert();
  test1.debug();
  std::cout << "trying pop_front, pop_back, erase\n";
  test1.pop_front();
  test1.pop_back();
  Essay::iterator itr = test1.begin();
  test1.erase(itr);
  
  std::cout << "--------------------\nTest 2: One Word Essay\n--------------------\n";
  test1.insert(test1.begin(), "one_word");
  test1.debug();
  std::cout << "backup:\n";
  test1.backup();
  test1.debug();
  test1.pop_back();
  std::cout << "reverting after popping:\n";
  test1.revert();
  test1.debug();
  test1.pop_back();
  test1.push_back("word_2");
  test1.debug();
